...
const AlbumCard = ({ albumitem, index }) => {
  ...
  return (
    <>
      <div className='flex flex-col font-medium text-gray-800 dark:text-gray-200 mb-2 overflow-hidden '>
        <figure className="overflow-hidden relative aspect-square p-3 rounded-md bg-gradient-to-b from-blue-100 via-blue-100 to-gray-500 dark:from-gray-800 dark:via-gray-700 dark:to-gray-600">
          {isVisible ? (
            <CloseIcon
          ...
          <ClickOutsideWrapper visible={isVisible} setvisible={setisVisible}>
        ...
        <span className='truncate w-28'> {albumitem?.albumname}</span>
      ...
      {!!renameOverlayVisible && (
        <Overlay onClose={onClose}>
          <div
            className="p-4 bg-white dark:bg-gray-800 rounded-xl w-full max-w-sm mx-auto"
