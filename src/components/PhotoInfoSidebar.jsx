...
const PhotoInfoSidebar = ({ photo, onClose }) => {
  ...
  return (
    <aside className="w-[220px] sm:w-[260px] md:w-[30vw] xl:w-[25vw] top-0 right-0 absolute h-fit md:relative bg-white dark:bg-gray-900 p-3 sm:p-5 md:p-7 flex flex-col justify-between shadow-md rounded-xl border border-blue-100 dark:border-gray-700">
      {/* Header */}
      <div className="flex justify-between items-center mb-6">
        <h2 className=" text-xl sm:text-2xl md:text-3xl font-semibold text-gray-900 dark:text-white">Info</h2>
        <Close
      ...
      {/* Info Section */}
      <div className="space-y-6 text-xs md:text-[16px] text-gray-700 dark:text-gray-300">
      ...
      <div className="mt-6">
        {photo.description && !editDescription ? (
          <div className="flex items-center justify-between border-b-[2px] border-b-gray-500 dark:border-b-gray-600 px-4 py-2">
            <span className="text-gray-800 text-xs md:text-base dark:text-gray-200">{description}</span>
            <EditIcon
              className="text-gray-500 cursor-pointer hover:text-gray-800 dark:hover:text-gray-300"
          ...
          <input
            type="text"
            className="w-full border-b-[2px] border-b-gray-500 dark:border-b-gray-600 outline-0 px-4 py-2 text-gray-800 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-400 bg-transparent text-xs md:text-base"
      ...
      {/* Save Button */}
      <button
        className="mt-6 w-full bg-blue-500 hover:bg-blue-600 text-white py-1 sm:py-2 px-4 rounded-lg text-sm font-medium transition duration-200"
