...
const Error = ({ errorMessage }) => {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen w-full dark:bg-gray-800 text-center px-4">
      ...
      <p className=" text-lg text-red-500 dark:text-gray-200 mb-4">{errorMessage || 'An unexpected error occurred.'}</p>
